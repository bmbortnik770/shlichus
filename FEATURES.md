...
**עדיין רק במערכת הקיימת (הפערים שנשארו):** עורך טריטוריה + ניהול קטגוריות + POI · ייבוא CSV/Sheets/Google Contacts · SMS/Twilio + תור · בונה קהלים וסגמנטים · מנוע תאריך עברי ליצירת ציוני דרך חדשים (קיימים מוצגים) · פיצול משפחה / נפטר / החלפת איש קשר ראשי · עורך יחידות דיור (קומות) · כרטיס מוסד · ניקוד מלא + הגדרותיו · ניהול סוגי אירועים · מיתוג · onboarding · Command Palette ‏(Ctrl+K) · דיאגרמת מבנים (עוגה) · מצב כהה מלא ב-v2. **אף מסך ישן לא נגנז.**
